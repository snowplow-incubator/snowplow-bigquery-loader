...
if [[ "${tag}" = *"${project_version}" ]]; then
    sbt "project loader" "runMain com.snowplowanalytics.storage.bigquery.loader.Main --project=snowplow-assets \
    ...
    sbt "project forwarder" "runMain com.snowplowanalytics.storage.bigquery.forwarder.Main --project=snowplow-assets \
