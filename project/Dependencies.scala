...
object Dependencies {
  ...
  val gax                = "com.google.api"        % "gax"                                     % V.gaxJava
  val gaxGrpc            = "com.google.api"        % "gax-grpc"                                % V.gaxJava
  val grpcNettyShaded    = "io.grpc"               % "grpc-netty-shaded"                       % V.grpc
  val grpcAuth           = "io.grpc"               % "grpc-auth"                               % V.grpc
  val grpcCore           = "io.grpc"               % "grpc-core"                               % V.grpc
  val grpcOkhttp         = "io.grpc"               % "grpc-okhttp"                             % V.grpc
