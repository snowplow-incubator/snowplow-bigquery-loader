...
object TableReference {
  ...
  object BigQueryTable {
    ...
    def create(args: MutatorCommand.Create, client: BigQuery, projectId: String, datasetId: String, tableId: String): IO[Table] = IO {
      ...
      val partition  = TimePartitioning.newBuilder(args.partitioningType)
        .setField(args.partitionField.name)
