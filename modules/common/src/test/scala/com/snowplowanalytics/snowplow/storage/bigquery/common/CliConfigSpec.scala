...
import com.snowplowanalytics.snowplow.storage.bigquery.common.config.EncodedHoconOrPath.{Base64Hocon, PathToHocon}
import com.snowplowanalytics.snowplow.storage.bigquery.common.config.EncodedJsonOrPath.{Base64Json, PathToJson}
